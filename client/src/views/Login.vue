      ...
      Auth.Login(this.model).then((response) => {
        ...
        if (this.retorno.status === 200) {
          this.$notify({
            type: "success",
            title:
              this.retorno.sucessMsg +
              " Seja Bem - Vindo " +
              this.retorno.user.name,
          });
